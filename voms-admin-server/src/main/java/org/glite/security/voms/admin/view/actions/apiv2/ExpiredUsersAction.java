...
public class ExpiredUsersAction extends BaseAction {
  ...
  List<VOMSUserTO> expiredUsers;

  @Override
  public String execute() throws Exception {

    expiredUsers = JSONSerializer
      .serialize((List<VOMSUser>) ListExpiredUsersOperation.instance()
        .execute());

    return SUCCESS;
  }

  public List<VOMSUserTO> getExpiredUsers() {
