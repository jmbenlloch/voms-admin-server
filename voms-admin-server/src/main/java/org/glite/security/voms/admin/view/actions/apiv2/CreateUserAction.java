...
public class CreateUserAction extends BaseAction implements ValidationAware {
  ...
  public String execute() throws Exception {
    ...
    CreateUserOperation op = CreateUserOperation.instance(user,
      certificateSubject, caSubject);
    VOMSUser newUser = (VOMSUser) op.execute();
    addActionMessage(String.format("User %s created succesfully.",
      newUser.getShortName(), newUser.getId()));
